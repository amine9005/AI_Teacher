      ...
      <div className="px-4 py-10 md:py-20">
        ...
        >
          <Button
            ...
            className="w-60 transform rounded-lg px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 dark:bg-white dark:text-black dark:hover:bg-gray-200"
          >
            Explore Now
          </Button>
